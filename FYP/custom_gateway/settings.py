"""
Django settings for custom_gateway project.
...
SECRET_KEY = 'django-insecure-bh5*+p%z0m5*4yi(h#^^i=#s@oc@$$*f_xn7#1=!hxqpp)6-vu'
...
ROOT_URLCONF = 'custom_gateway.urls'
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/payments/pay/'  # Redirect after successful login
...
CHANNEL_LAYERS = {
    'default': {
        'BACKEND': 'channels.layers.InMemoryChannelLayer',  # Good for development
    },
}
...
AUTH_USER_MODEL = 'payments.LegacyUser'

AUTHENTICATION_BACKENDS = [
    'payments.auth_backends.LegacyBackend',
]
